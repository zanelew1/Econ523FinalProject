...
#set wd to the folder ReplicationFiles after downloading the package
setwd("/Users/connorlewis_macbookpro/Desktop/Econ523FinalProject/Extension&ReplicationFiles/ReplicationFiles")
require(readxl)
library(seasonal)
require(dynlm)
require(car)
